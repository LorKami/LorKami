        ...
        <div className="WhitePapperSection">
          ...
          <div className="IndexRight">
            <div className="IndexMenu">
              <p>PAGINA WEB</p>
              <a href="#PasoUno">CREAR PROYECTO</a>
              <a href="#Recursos">RECURSOS</a>
              <a href="#Deployar">DEPLOYAR DOMINIO</a>
              <a href="#Extra">EXTRA</a>
              <a href="#DeployarVercel">DEPLOYAR VERCEL</a>

              <p>CODIGOS MAS USADOS</p>
              <a href="#ReactIcons">React-Icons</a>
              <a href="#Metadatos">Metadatos</a>
              <a href="#Link"><code>{`<Link>`}</code></a>
              <a href="#FontPer">Font personalizada</a>
              <a href="#ScrollBar">ScrollBar</a>
              <a href="#Responsive">Responsive</a>
              <a href="#MenuSticky">Menu Sticky</a>
              <a href="#GRID">GRID Galeria</a>
              <a href="#BorderStyle">Efecto Border</a>
              <a href="#BarraDeProgreso">Barra de Progrso</a>
              <a href="#ConvesorImage">Magick Imagenes</a>
            </div>
          </div>
